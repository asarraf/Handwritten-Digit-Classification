...
% w1 => 50 X 720
% w2 => 10 X 51
% training_data => 50000 X 719
% training_label => 50000 X 1
...
% Create a matrix to store the values of 50000 observations
% THere is one extra column in the x to store the initial bias
x = ones(N, size(w1, 2));                           % 50000 X 720
x(1:size(training_data,1), 1:size(training_data,2)) = training_data;

% aj => 50000 X 50
% zj => 50000 X 51
% aj is the weighted sum of the initial input
...
%bk => 50000 X 10
%yk => 50000 X 10
% bk is the weighted sum of the reading generated from the hidden element
bk = zj * transpose(w2);
...
% EnW is the error from each input data n
% EnW is a vector 50000 X 1
